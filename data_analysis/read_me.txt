...
The model was written in the Python programming language and can be downloaded from https://doi.org/10.5281/zenodo.3763829
...
DATA-SPECIFIC INFORMATION FOR: files in directories 
